...
function shriek( word, times ) {
  ...
  return word.toUpperCase() + exclaims
}
...
module.exports = {
  ...
  b: shriek // change undefined to be the name of the function defined to return the string with exclamations (the second todo)
}
